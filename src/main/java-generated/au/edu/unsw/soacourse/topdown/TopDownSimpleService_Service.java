 ...
 * 2015-04-15T16:40:59.029+10:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "TopDownSimpleService", 
                  wsdlLocation = "file:/D:/Repos/COMP9322-ass1/src/main/resources/wsdl/TopDownSimpleService.wsdl",
...
public class TopDownSimpleService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Repos/COMP9322-ass1/src/main/resources/wsdl/TopDownSimpleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TopDownSimpleService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/Repos/COMP9322-ass1/src/main/resources/wsdl/TopDownSimpleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
