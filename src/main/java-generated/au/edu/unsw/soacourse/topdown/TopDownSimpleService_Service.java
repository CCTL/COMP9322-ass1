 ...
 * 2015-04-16T19:21:52.319+10:00
 * Generated source version: 3.0.4
 * 
 */
@WebServiceClient(name = "TopDownSimpleService", 
                  wsdlLocation = "wsdl/TopDownSimpleService.wsdl",
...
public class TopDownSimpleService_Service extends Service {
    ...
    static {
        URL url = TopDownSimpleService_Service.class.getResource("wsdl/TopDownSimpleService.wsdl");
        if (url == null) {
            url = TopDownSimpleService_Service.class.getClassLoader().getResource("wsdl/TopDownSimpleService.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(TopDownSimpleService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "wsdl/TopDownSimpleService.wsdl");
        }       
        WSDL_LOCATION = url;
    }
